<?php namespace App\Http\Controllers;
	...
	class AdminVideo14Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"EmbedCode","name"=>"embedCode"];
			...
			$this->form[] = ['label'=>'EmbedCode','name'=>'embedCode','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"EmbedCode","name"=>"embedCode","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
