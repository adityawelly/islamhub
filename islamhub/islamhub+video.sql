...
(12, '3234-12597-1-PB1.pdf', 'tes', 'tes');
...
--
-- Table structure for table `tbl_setting_genres`
--
...
--
-- Dumping data for table `tbl_setting_genres`
--
...
--
-- Table structure for table `tbl_setting_seasons`
--
...
--
-- Dumping data for table `tbl_setting_seasons`
--
...
--
-- Table structure for table `tbl_setting_types`
--
...
--
-- Dumping data for table `tbl_setting_types`
--
...
--
-- Table structure for table `tbl_setting_years`
--
...
--
-- Dumping data for table `tbl_setting_years`
--
...
--
-- Table structure for table `tbl_video_details`
--
...
--
-- Dumping data for table `tbl_video_details`
--
...
--
-- Table structure for table `tbl_video_locations`
--
...
--
-- Dumping data for table `tbl_video_locations`
--
...
--
-- Table structure for table `tbl_video_reports`
--
...
--
-- Dumping data for table `tbl_video_reports`
--
...
--
-- Table structure for table `tbl_video_viewers`
--
...
--
-- Dumping data for table `tbl_video_viewers`
--
...
--
-- Structure for view `view_video_details`
--
...
--
-- Structure for view `view_video_genres`
--
...
--
-- Structure for view `view_video_reports`
--
...
--
-- Constraints for table `tbl_setting_genres`
--
ALTER TABLE `tbl_setting_genres`
...
--
-- Constraints for table `tbl_setting_seasons`
--
ALTER TABLE `tbl_setting_seasons`
...
--
-- Constraints for table `tbl_setting_types`
--
ALTER TABLE `tbl_setting_types`
...
--
-- Constraints for table `tbl_setting_years`
--
ALTER TABLE `tbl_setting_years`
...
--
-- Constraints for table `tbl_video_details`
--
ALTER TABLE `tbl_video_details`
...
--
-- Constraints for table `tbl_video_genres`
--
ALTER TABLE `tbl_video_genres`
...
--
-- Constraints for table `tbl_video_locations`
--
ALTER TABLE `tbl_video_locations`
